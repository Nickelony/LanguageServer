...
/// </summary>
/// <param name="HoveredOffset">The zero-based document offset under the mouse, or <c>-1</c> when none.</param>
/// <param name="RequestOffset">The zero-based document offset used for the hover request, or <c>-1</c> when no request is applicable.</param>
