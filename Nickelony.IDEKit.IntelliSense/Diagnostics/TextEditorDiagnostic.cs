...
public sealed class TextEditorDiagnostic
{
	...
	/// </summary>
	/// <remarks>
	/// <paramref name="startOffset"/> is clamped to zero. An <paramref name="endOffset"/> before
	/// or at the normalized start is advanced by one offset.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// The range uses an inclusive start and exclusive end. Empty or reversed ranges do not
	/// intersect a diagnostic.
	/// </remarks>
