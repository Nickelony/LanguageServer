namespace Nickelony.IDEKit.Core.Formatting.Tests;
...
public sealed class WhiteSpaceConverterTests
{
	...
	{
		Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => WhiteSpaceConverter.ConvertSpacesToTabs("code", 0));
	}

	[TestMethod]
	public void ConvertSpacesToTabs_NegativeTabSize_Throws()
	{
		Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => WhiteSpaceConverter.ConvertSpacesToTabs("code", -4));
	}

	[TestMethod]
	public void ConvertTabsToSpaces_ZeroTabSize_Throws()
	{
		Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => WhiteSpaceConverter.ConvertTabsToSpaces("code", 0));
	}

	[TestMethod]
	public void ConvertTabsToSpaces_NegativeTabSize_Throws()
	{
		Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => WhiteSpaceConverter.ConvertTabsToSpaces("code", -4));
	}
	...
	[TestMethod]
	public void ConvertSpacesToTabs_PreservesNonIndentationContent()
	{
