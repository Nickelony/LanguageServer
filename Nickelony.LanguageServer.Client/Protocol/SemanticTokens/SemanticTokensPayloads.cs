...
/// </summary>
/// <param name="Start">The start index of the edit in the semantic-token integer stream, when present on the wire.</param>
/// <param name="DeleteCount">The number of integers to delete at the start index, when present on the wire.</param>
/// <param name="Data">The replacement integer data to insert, when present on the wire.</param>
